            ...
            <tr>
                ...
                <td width="75%" align="center">
                    <jsp:include page="/WEB-INF/views/banner.jsp">
                        <jsp:param name="subtitle" value="以裝置序號查詢"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
                ...
                <td width="75%" align="center">
                    <c:if test="${result == null}">
                        <jsp:include page="/WEB-INF/subpages/record/querybydsn.jsp"/>
                    </c:if>
                    <c:if test="${result != null}">
                        <jsp:include page="/WEB-INF/subpages/record/querybydsnresult.jsp"/>
                    </c:if>

            ...
            <tr>
                ...
                <td width="75%" align="center">
                    <jsp:include page="/WEB-INF/views/banner.jsp">
                        <jsp:param name="subtitle" value="修改顧客資料"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
                ...
                <td width="75%" align="center">
                    <c:if test="${result == null || result == 0}">
                        <jsp:include page="/WEB-INF/subpages/customer/updatequery.jsp"/>
                    </c:if>
                    <c:if test="${result == 1 }">
                        <jsp:include page="/WEB-INF/subpages/customer/updateconfirm.jsp"/>
                    </c:if>
                    <c:if test="${result == 2}">
                        <jsp:include page="/WEB-INF/subpages/customer/updatesuccessful.jsp"/>
                    </c:if>
                </td>
            </tr>
            <tr>

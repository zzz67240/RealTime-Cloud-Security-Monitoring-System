            ...
            <tr>
                ...
                <td width="75%" align="center">
                    <jsp:include page="/WEB-INF/views/banner.jsp">
                        <jsp:param name="subtitle" value="刪除顧客資料"/>
                    </jsp:include>
                </td>
            </tr>
            <tr>
                ...
                <td width="75%" align="center">
                    <c:if test="${result == null}">
                        <jsp:include page="/WEB-INF/subpages/customer/delete.jsp"/>
                    </c:if>
                    <c:if test="${result != null}">
                        <jsp:include page="/WEB-INF/subpages/customer/deletesuccessful.jsp"/>
                    </c:if>
                </td>
            </tr>
            <tr>
